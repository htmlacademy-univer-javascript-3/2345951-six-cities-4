...
const REVIEW_TEXT = 'Amazing views, which give you the opportunity to unwind and forget about everything in the world';
...
test('Отправка комментария', async ({ page }) => {
  ...
  expect(reviewAuthor).toBe('alex.pushkin');
